...
const Drone = () => {
  ...
  <div id="carouselExampleCaptions" className="carousel slide" data-bs-ride="carousel">
    <div className="carousel-inner">
      <div className="carousel-item active">
        <img src="images/dronebg.jpg" className="d-block w-100" alt="..." />
        <div className="carousel-caption   d-md-block" style={{marginBottom: 40}}>
          <h1 className="display-4 text-center" style={{fontWeight: 700, fontFamily: '"Poppins", sans-serif', color: '#ffd034'}}>Drone Photography</h1>
      ...
      <div className="row">
        <div className="col-lg-6 col-sm-12 col-md-6">
          <div id="carouselExampleSlidesOnly" className="carousel slide" data-bs-ride="carousel">
            <div className="carousel-inner">
              <div className="carousel-item active">
                <img src="images/d1.jpg" className="d-block w-100" alt="..." data-aos="fade-up" />
              </div>
            </div>
          </div>
        </div>
        <div className="col-lg-6 col-sm-12 col-md-6">
          <div id="carouselExampleSlidesOnly" className="carousel slide" data-bs-ride="carousel">
            <div className="carousel-inner">
              <div className="carousel-item active">
                <img src="images/d2.jpg" className="d-block w-100" alt="..." data-aos="fade-up" />
              </div>
            </div>
          </div>
        </div>
      ...
      <div className="row">
        <div className="col-lg-6 col-sm-12 col-md-6">
          <div id="carouselExampleSlidesOnly" className="carousel slide" data-bs-ride="carousel">
            <div className="carousel-inner">
              <div className="carousel-item active">
                <img src="images/d3.jpg" className="d-block w-100" alt="..." data-aos="fade-up" />
              </div>
            </div>
          </div>
        </div>
        <div className="col-lg-6 col-sm-12 col-md-6">
          <div id="carouselExampleSlidesOnly" className="carousel slide" data-bs-ride="carousel">
            <div className="carousel-inner">
              <div className="carousel-item active">
                <img src="images/d4.jpg" className="d-block w-100" alt="..." data-aos="fade-up" />
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="row">
          <div className="col-lg-6 col-sm-12 col-md-6">
            <div id="carouselExampleSlidesOnly" className="carousel slide" data-bs-ride="carousel">
              <div className="carousel-inner">
                <div className="carousel-item active">
                  <img src="images/d5.jpg" className="d-block w-100" alt="..." data-aos="fade-up" />
                </div>
              </div>
            </div>
          </div>
          <div className="col-lg-6 col-sm-12 col-md-6">
            <div id="carouselExampleSlidesOnly" className="carousel slide" data-bs-ride="carousel">
              <div className="carousel-inner">
                <div className="carousel-item active">
                  <img src="images/d6.jpg" className="d-block w-100" alt="..." data-aos="fade-up" />
                </div>
              </div>
            </div>
          </div>
        ...
        <div className="row">
          <div className="col-lg-6 col-sm-12 col-md-6">
            <div id="carouselExampleSlidesOnly" className="carousel slide" data-bs-ride="carousel">
              <div className="carousel-inner">
                <div className="carousel-item active">
                  <img src="images/d7.jpg" className="d-block w-100" alt="..." data-aos="fade-up" />
                </div>
              </div>
            </div>
          </div>
          <div className="col-lg-6 col-sm-12 col-md-6">
            <div id="carouselExampleSlidesOnly" className="carousel slide" data-bs-ride="carousel">
              <div className="carousel-inner">
                <div className="carousel-item active">
                  <img src="images/d8.jpg" className="d-block w-100" alt="..." data-aos="fade-up" />
                </div>
              </div>
            </div>
          </div>
        ...
        <div className="row">
          <div className="col-lg-6 col-sm-12 col-md-6">
            <div id="carouselExampleSlidesOnly" className="carousel slide" data-bs-ride="carousel">
              <div className="carousel-inner">
                <div className="carousel-item active">
                  <img src="images/d9.jpg" className="d-block w-100" alt="..." data-aos="fade-up" />
                </div>
              </div>
            </div>
          </div>
          <div className="col-lg-6 col-sm-12 col-md-6">
            <div id="carouselExampleSlidesOnly" className="carousel slide" data-bs-ride="carousel">
              <div className="carousel-inner">
                <div className="carousel-item active">
                  <img src="images/d10.jpg" className="d-block w-100" alt="..." data-aos="fade-up" />
                </div>
              </div>
            </div>
          </div>
        ...
        <div className="row">
          <div className="col-lg-6 col-sm-12 col-md-6">
            <div id="carouselExampleSlidesOnly" className="carousel slide" data-bs-ride="carousel">
              <div className="carousel-inner">
                <div className="carousel-item active">
                  <img src="images/d11.jpg" className="d-block w-100" alt="..." data-aos="fade-up" />
                </div>
              </div>
            </div>
          </div>
          <div className="col-lg-6 col-sm-12 col-md-6">
            <div id="carouselExampleSlidesOnly" className="carousel slide" data-bs-ride="carousel">
              <div className="carousel-inner">
                <div className="carousel-item active">
                  <img src="images/d12.jpg" className="d-block w-100" alt="..." data-aos="fade-up" />
                </div>
              </div>
            </div>
          </div>
        ...
        <div className="row">
          <div className="col-lg-6 col-sm-12 col-md-6">
            <div id="carouselExampleSlidesOnly" className="carousel slide" data-bs-ride="carousel">
              <div className="carousel-inner">
                <div className="carousel-item active">
                  <img src="images/d13.jpg" className="d-block w-100" alt="..." data-aos="fade-up" />
                </div>
              </div>
            </div>
          </div>
          <div className="col-lg-6 col-sm-12 col-md-6">
            <div id="carouselExampleSlidesOnly" className="carousel slide" data-bs-ride="carousel">
              <div className="carousel-inner">
                <div className="carousel-item active">
                  <img src="images/d14.jpg" className="d-block w-100" alt="..." data-aos="fade-up" />
                </div>
              </div>
            </div>
          </div>
        ...
        <div className="row">
          <div className="col-lg-6 col-sm-12 col-md-6">
            <div id="carouselExampleSlidesOnly" className="carousel slide" data-bs-ride="carousel">
              <div className="carousel-inner">
                <div className="carousel-item active">
                  <img src="images/d15.jpg" className="d-block w-100" alt="..." data-aos="fade-up" />
                </div>
              </div>
            </div>
          </div>
          <div className="col-lg-6 col-sm-12 col-md-6">
            <div id="carouselExampleSlidesOnly" className="carousel slide" data-bs-ride="carousel">
              <div className="carousel-inner">
                <div className="carousel-item active">
                  <img src="images/d16.jpg" className="d-block w-100" alt="..." data-aos="fade-up" />
                </div>
              </div>
            </div>
          </div>
        ...
        <div className="row">
          <div className="col-lg-6 col-sm-12 col-md-6">
            <div id="carouselExampleSlidesOnly" className="carousel slide" data-bs-ride="carousel">
              <div className="carousel-inner">
                <div className="carousel-item active">
                  <img src="images/d17.jpg" className="d-block w-100" alt="..." data-aos="fade-up" />
                </div>
              </div>
            </div>
          </div>
          <div className="col-lg-6 col-sm-12 col-md-6">
            <div id="carouselExampleSlidesOnly" className="carousel slide" data-bs-ride="carousel">
              <div className="carousel-inner">
                <div className="carousel-item active">
                  <img src="images/d18.jpg" className="d-block w-100" alt="..." data-aos="fade-up" />
                </div>
              </div>
            </div>
          </div>
        ...
        <div className="row">
          <div className="col-lg-6 col-sm-12 col-md-6">
            <div id="carouselExampleSlidesOnly" className="carousel slide" data-bs-ride="carousel">
              <div className="carousel-inner">
                <div className="carousel-item active">
                  <img src="images/d19.jpg" className="d-block w-100" alt="..." data-aos="fade-up" />
                </div>
              </div>
            </div>
          </div>
          <div className="col-lg-6 col-sm-12 col-md-6">
            <div id="carouselExampleSlidesOnly" className="carousel slide" data-bs-ride="carousel">
              <div className="carousel-inner">
                <div className="carousel-item active">
                  <img src="images/d20.jpg" className="d-block w-100" alt="..." data-aos="fade-up" />
                </div>
              </div>
            </div>
          </div>
  ...
  {/* <center><a className="btn btn- btn-lg" role="button" style={{backgroundColor: '#ffd034', borderRadius: 40, letterSpacing: 2}} onclick="button1()" id="b1">See All</a></center> */}
  <br /><br /><br />
