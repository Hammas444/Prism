...
const Landscape = () => {
  ...
  <div id="carouselExampleCaptions" className="carousel slide" data-bs-ride="carousel">
    <div className="carousel-inner">
      <div className="carousel-item active">
        <img src="images/landscapebg.jpg" className="d-block w-100" alt="..." />
        <div className="carousel-caption   d-md-block" style={{marginBottom: 40}}>
          <h1 className="display-4 text-center" style={{fontWeight: 700, fontFamily: '"Poppins", sans-serif', color: '#ffd034'}}>Landscape Photography</h1>
      ...
      <div className="row">
        <div className="col-lg-6 col-sm-12 col-md-6">
          <div id="carouselExampleSlidesOnly" className="carousel slide" data-bs-ride="carousel">
            <div className="carousel-inner">
              <div className="carousel-item active">
                <img src="images/l1.jpg" className="d-block w-100" alt="..." data-aos="fade-up" />
              </div>
            </div>
          </div>
        </div>
        <div className="col-lg-6 col-sm-12 col-md-6">
          <div id="carouselExampleSlidesOnly" className="carousel slide" data-bs-ride="carousel">
            <div className="carousel-inner">
              <div className="carousel-item active">
                <img src="images/l2.jpg" className="d-block w-100" alt="..." data-aos="fade-up" />
              </div>
            </div>
          </div>
        </div>
      ...
      <div className="row">
        <div className="col-lg-6 col-sm-12 col-md-6">
          <div id="carouselExampleSlidesOnly" className="carousel slide" data-bs-ride="carousel">
            <div className="carousel-inner">
              <div className="carousel-item active">
                <img src="images/l3.jpg" className="d-block w-100" alt="..." data-aos="fade-up" />
              </div>
            </div>
          </div>
        </div>
        <div className="col-lg-6 col-sm-12 col-md-6">
          <div id="carouselExampleSlidesOnly" className="carousel slide" data-bs-ride="carousel">
            <div className="carousel-inner">
              <div className="carousel-item active">
                <img src="images/l4.jpg" className="d-block w-100" alt="..." data-aos="fade-up" />
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="row">
          <div className="col-lg-6 col-sm-12 col-md-6">
            <div id="carouselExampleSlidesOnly" className="carousel slide" data-bs-ride="carousel">
              <div className="carousel-inner">
                <div className="carousel-item active">
                  <img src="images/l5.jpg" className="d-block w-100" alt="..." data-aos="fade-up" />
                </div>
              </div>
            </div>
          </div>
          <div className="col-lg-6 col-sm-12 col-md-6">
            <div id="carouselExampleSlidesOnly" className="carousel slide" data-bs-ride="carousel">
              <div className="carousel-inner">
                <div className="carousel-item active">
                  <img src="images/l6.jpg" className="d-block w-100" alt="..." data-aos="fade-up" />
                </div>
              </div>
            </div>
          </div>
        ...
        <div className="row">
          <div className="col-lg-6 col-sm-12 col-md-6">
            <div id="carouselExampleSlidesOnly" className="carousel slide" data-bs-ride="carousel">
              <div className="carousel-inner">
                <div className="carousel-item active">
                  <img src="images/l7.jpg" className="d-block w-100" alt="..." data-aos="fade-up" />
                </div>
              </div>
            </div>
          </div>
          <div className="col-lg-6 col-sm-12 col-md-6">
            <div id="carouselExampleSlidesOnly" className="carousel slide" data-bs-ride="carousel">
              <div className="carousel-inner">
                <div className="carousel-item active">
                  <img src="images/l8.jpg" className="d-block w-100" alt="..." data-aos="fade-up" />
                </div>
              </div>
            </div>
          </div>
        ...
        <div className="row">
          <div className="col-lg-6 col-sm-12 col-md-6">
            <div id="carouselExampleSlidesOnly" className="carousel slide" data-bs-ride="carousel">
              <div className="carousel-inner">
                <div className="carousel-item active">
                  <img src="images/l9.jpg" className="d-block w-100" alt="..." data-aos="fade-up" />
                </div>
              </div>
            </div>
          </div>
          <div className="col-lg-6 col-sm-12 col-md-6">
            <div id="carouselExampleSlidesOnly" className="carousel slide" data-bs-ride="carousel">
              <div className="carousel-inner">
                <div className="carousel-item active">
                  <img src="images/l10.jpg" className="d-block w-100" alt="..." data-aos="fade-up" />
                </div>
              </div>
            </div>
          </div>
        ...
        <div className="row">
          <div className="col-lg-6 col-sm-12 col-md-6">
            <div id="carouselExampleSlidesOnly" className="carousel slide" data-bs-ride="carousel">
              <div className="carousel-inner">
                <div className="carousel-item active">
                  <img src="images/l11.jpg" className="d-block w-100" alt="..." data-aos="fade-up" />
                </div>
              </div>
            </div>
          </div>
          <div className="col-lg-6 col-sm-12 col-md-6">
            <div id="carouselExampleSlidesOnly" className="carousel slide" data-bs-ride="carousel">
              <div className="carousel-inner">
                <div className="carousel-item active">
                  <img src="images/l12.jpg" className="d-block w-100" alt="..." data-aos="fade-up" />
                </div>
              </div>
            </div>
          </div>
        ...
        <div className="row">
          <div className="col-lg-6 col-sm-12 col-md-6">
            <div id="carouselExampleSlidesOnly" className="carousel slide" data-bs-ride="carousel">
              <div className="carousel-inner">
                <div className="carousel-item active">
                  <img src="images/l13.jpg" className="d-block w-100" alt="..." data-aos="fade-up" />
                </div>
              </div>
            </div>
          </div>
          <div className="col-lg-6 col-sm-12 col-md-6">
            <div id="carouselExampleSlidesOnly" className="carousel slide" data-bs-ride="carousel">
              <div className="carousel-inner">
                <div className="carousel-item active">
                  <img src="images/l14.jpg" className="d-block w-100" alt="..." data-aos="fade-up" />
                </div>
              </div>
            </div>
          </div>
        ...
        <div className="row">
          <div className="col-lg-6 col-sm-12 col-md-6">
            <div id="carouselExampleSlidesOnly" className="carousel slide" data-bs-ride="carousel">
              <div className="carousel-inner">
                <div className="carousel-item active">
                  <img src="images/l15.jpg" className="d-block w-100" alt="..." data-aos="fade-up" />
                </div>
              </div>
            </div>
          </div>
          <div className="col-lg-6 col-sm-12 col-md-6">
            <div id="carouselExampleSlidesOnly" className="carousel slide" data-bs-ride="carousel">
              <div className="carousel-inner">
                <div className="carousel-item active">
                  <img src="images/l16.jpg" className="d-block w-100" alt="..." data-aos="fade-up" />
                </div>
              </div>
            </div>
          </div>
        ...
        <div className="row">
          <div className="col-lg-6 col-sm-12 col-md-6">
            <div id="carouselExampleSlidesOnly" className="carousel slide" data-bs-ride="carousel">
              <div className="carousel-inner">
                <div className="carousel-item active">
                  <img src="images/l17.jpg" className="d-block w-100" alt="..." data-aos="fade-up" />
                </div>
              </div>
            </div>
          </div>
          <div className="col-lg-6 col-sm-12 col-md-6">
            <div id="carouselExampleSlidesOnly" className="carousel slide" data-bs-ride="carousel">
              <div className="carousel-inner">
                <div className="carousel-item active">
                  <img src="images/l18.jpg" className="d-block w-100" alt="..." data-aos="fade-up" />
                </div>
              </div>
            </div>
          </div>
        ...
        <div className="row">
          <div className="col-lg-6 col-sm-12 col-md-6">
            <div id="carouselExampleSlidesOnly" className="carousel slide" data-bs-ride="carousel">
              <div className="carousel-inner">
                <div className="carousel-item active">
                  <img src="images/l19.jpg" className="d-block w-100" alt="..." data-aos="fade-up" />
                </div>
              </div>
            </div>
          </div>
          <div className="col-lg-6 col-sm-12 col-md-6">
            <div id="carouselExampleSlidesOnly" className="carousel slide" data-bs-ride="carousel">
              <div className="carousel-inner">
                <div className="carousel-item active">
                  <img src="images/l20.jpg" className="d-block w-100" alt="..." data-aos="fade-up" />
                </div>
              </div>
            </div>
          </div>
  ...
  {/* <center><a className="btn btn- btn-lg" role="button" style={{backgroundColor: '#ffd034', borderRadius: 40, letterSpacing: 2}} onclick="button3()" id="b3">See All</a></center> */}
  <br /><br /><br />
